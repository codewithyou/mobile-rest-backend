...
public class MybatisDao extends SqlSessionDaoSupport implements DAO {
    ...
    @Override
    public Object insert(String key, Object parameter) throws Exception {
        if (logger.isDebugEnabled()) {
            getExecuteSql(key, parameter);
        }
        return getSqlSession().insert(key, parameter);
    }
     ...
     */
    public Object update(String key, Object parameter) {
        if (logger.isDebugEnabled()) {
            getExecuteSql(key, parameter);
        }
        return getSqlSession().update(key, parameter);
    }


    @Override
    public Object delete(String key, Object parameter) throws Exception {
        if (logger.isDebugEnabled()) {
            getExecuteSql(key, parameter);
        }
        return getSqlSession().delete(key, parameter);
    }
    ...
    public <T> T getOne(String key, Object parameter) {
        if (logger.isDebugEnabled()) {
            getExecuteSql(key, parameter);
        }
